...
This repository contains the source code of the agent plugin for the email integration.

This integration allows you to send emails with attachments via the Superblocks Sendgrid mailer.
